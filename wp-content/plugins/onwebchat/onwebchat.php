...
function onwebchat_init_menu_page() {
	...
	*****************************************************************/
	if ( isset( $_POST["action"] ) && $_POST["action"] == "login" ) {
		...
		update_option('onwebchat_plugin_option_hide', $_POST['onwebchat_plugin_option_hide']); //an einai stin proti selida tote to kanei keno (opote by default den einai epilegmeno)
	}
